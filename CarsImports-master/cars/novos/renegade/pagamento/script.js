...
function generateBoleto() {
    ...
    const valorOriginal = 150000.00;
    const percentualJuros = 8;
    const meses = 12;
    ...
    const codigoBarras = "34191.01234 56789.000001 23456.789012 3 456700123456";
    ...
    const pagador = "Tatiane Costa Silva";
    const cpfPagador = " 852.147.963-00";
